"""seed prescription permissions

Adds `prescriptions.view` and `prescriptions.manage` (P3-B05) and grants
them to every role listed for them in `ROLE_PERMISSION_SEED`.

Revision ID: e5b9d3c48a71
Revises: c73a5f8e2d94
Create Date: 2026-09-17 11:01:00.000000
...
revision: str = 'e5b9d3c48a71'
down_revision: Union[str, None] = 'c73a5f8e2d94'
branch_labels: Union[str, Sequence[str], None] = None
depends_on: Union[str, Sequence[str], None] = None

NEW_PERMISSION_CODES = ["prescriptions.view", "prescriptions.manage"]
