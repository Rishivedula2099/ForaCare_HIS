"""seed consultation permissions

Adds `consultations.view` and `consultations.manage` (P3-B04) and grants
them to every role listed for them in `ROLE_PERMISSION_SEED`.

Revision ID: d8e3a5c72f19
Revises: f4c2b8e91a67
Create Date: 2026-09-17 10:01:00.000000
...
revision: str = 'd8e3a5c72f19'
down_revision: Union[str, None] = 'f4c2b8e91a67'
branch_labels: Union[str, Sequence[str], None] = None
depends_on: Union[str, Sequence[str], None] = None

NEW_PERMISSION_CODES = ["consultations.view", "consultations.manage"]
