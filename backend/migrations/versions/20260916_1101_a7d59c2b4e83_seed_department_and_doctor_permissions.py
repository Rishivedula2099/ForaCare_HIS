"""seed department and doctor permissions

Adds the `departments.view`, `departments.manage`, `doctors.view`,
`doctors.manage` permission rows (P3-F01) and grants them to the roles
listed for those codes in `ROLE_PERMISSION_SEED` (SUPER_ADMIN already gets
every permission via `ALL_PERMISSION_CODES`, HOSPITAL_ADMIN/DOCTOR/NURSE/
RECEPTIONIST get view, HOSPITAL_ADMIN also gets manage).

Revision ID: a7d59c2b4e83
Revises: f1a6c8d93e21
Create Date: 2026-09-16 11:01:00.000000
...
revision: str = 'a7d59c2b4e83'
down_revision: Union[str, None] = 'f1a6c8d93e21'
branch_labels: Union[str, Sequence[str], None] = None
depends_on: Union[str, Sequence[str], None] = None

NEW_PERMISSION_CODES = ["departments.view", "departments.manage", "doctors.view", "doctors.manage"]
